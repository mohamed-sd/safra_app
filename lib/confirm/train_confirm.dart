...
class TrainConfirm extends StatefulWidget {
  @override
  State<TrainConfirm> createState() => _FlightConfirmState();
}

class _FlightConfirmState extends State<TrainConfirm>
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context)=>Payment(flag: 'train'))
                        );
                      },
                      child: Container(

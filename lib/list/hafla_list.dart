...
import 'package:safra_app/detailes/hafla_details.dart';
import 'package:safra_app/filter_screen.dart';
import 'package:safra_app/widgets/custom_back_button.dart';
import '../appColors.dart';

class HaflaList extends StatelessWidget {
  const HaflaList({Key? key}) : super(key: key);
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>HaflaDetails()));
                    },
                    child: Container(
                      margin:
